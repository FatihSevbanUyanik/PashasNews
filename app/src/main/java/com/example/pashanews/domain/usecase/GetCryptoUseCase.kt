...
class GetCryptoUseCase @Inject constructor(private val currencyRepository: CurrencyRepository) {
    suspend fun execute(): Flow<DataState<List<Currency>>> = currencyRepository.getCryptoCurrenciesFromApi()
}